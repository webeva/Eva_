  ...
  async function isFollow(id) {
    if (localStorage.getItem("deso_user_key")) {
      if (localStorage.getItem("deso_user_key") != id) {
        const Following = await deso.checkFollow(
                  ...
                  <div key={index} className={style.container}>
                    <div style={{ display: "inline-block" }}>
                      <ProfilePic
                        ...
                        IsNFT={
                          value.ExtraData
                            ? value.ExtraData.NFTProfilePictureUrl
                            : null
                        }
                      ></ProfilePic>
                      <button
                        onClick={() => FollowEdit(PublicKeyBase58Check)}
                      ...
                      >
                        <p
                          ...
                          id={"followingState" + PublicKeyBase58Check}
                        >
                          {following[index]}
                        </p>
                      </button>
