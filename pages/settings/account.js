    ...
    <>
      ...
      <div className={style.content}>
        {HasAnAccount ? (
          ...
          <div className={style.buyDeso}>
            <h2 style={{ color: "var(--color-white)" }}>
              To Create A Profile You Need Some DeSo
            </h2>
            <p style={{ color: "var(--color-white)", paddingRight: "100px" }}>
              DeSo is a cryptocurrency used on Eva. To get started you only need
              0.001 DeSo or around $0.01 USD
            </p>
            <button
              onClick={() => starterDeso()}
              style={{
        ...
        >
          <input
            ...
            value={fr}
            placeholder="Founder Reward Percentage"
            style={{
              color: "var(--color-white)",
              fill: "rgb(104, 115, 141)",
              fontSize: "16px",
        ...
        <button onClick={() => updateProfile()} className={style.button}>
          Update
        </button>
      </div>
    </>
