export default function Terms() {
  return (
    <div style={{ color: "white", marginLeft: "10px" }}>
      ...
      <p>
        Welcome to <b>Eva</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>https://eva-phi.vercel.app/</b> (together or
        individually “Service”) operated by <b>Eva</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>web3eva@gmail.com</b> so we can try to find a solution. These Terms
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at web3eva@gmail.com.
      </p>
      ...
      <p>
        Eva has the right but not the obligation to monitor and edit all Content
        provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property
        of Eva or used with permission. You may not distribute, modify,
      ...
      <p>
        ...
        Eva and its licensors. Service is protected by copyright, trademark, and
      ...
      <p>
        ...
        to web3eva@gmail.com, with the subject line: “Copyright Infringement”
      ...
      <p>
        You may provide us either directly at web3eva@gmail.com or via third
      ...
      <p>
        ...
        are not owned or controlled by Eva.
      </p>
      <p>
        Eva has no control over, and assumes no responsibility for the content,
      ...
      <p>
        ...
        of Canada, which governing law applies to agreement without regard to
